    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media(); ?>/images/fotos/<?=$_SESSION['userData']['nombre_foto']?>" alt="User Image">
            <div>
            ...
            <?php if (!empty($_SESSION['permisos'][3]['r'])) { ?>
                <li>
                    <a class="app-menu__item" href="<?= base_url(); ?>/clientes">
                        ...
                        <span class="app-menu__label">Comuneros</span>
                    </a>
                </li>
            <?php } ?>
            <?php if (!empty($_SESSION['permisos'][4]['r'])) { ?>
                <li>
                    <a class="app-menu__item" href="<?= base_url(); ?>/roles">
                        <i class="app-menu__icon fa  fa-user-tag" aria-hidden="true"></i>
