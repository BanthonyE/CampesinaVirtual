<?php
	class Carnets extends Controllers{
		...
		public function Carnets()
		{
			...
			$data['page_tag'] = "Carnets";
			$data['page_title'] = "Carnets <small>Tienda Virtual</small>";
			$data['page_name'] = "carnets";
			$data['page_functions_js'] = "functions_carnets.js";
			$this->views->getView($this,"carnets",$data);
		}
